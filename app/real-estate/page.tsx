      ...
      <section className="py-24 px-4 bg-gray-50 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <blockquote className="text-2xl font-medium text-gray-800 leading-relaxed mb-8">
            "My leads get answered instantly now. I've closed 2 extra deals this month because of faster follow-up."
          </blockquote>
          <p className="font-bold text-gray-900">James Thornton</p>
          <p className="text-gray-500 text-sm">Real Estate Agent, NYC</p>
        </div>
      </section>
